...
mod use_bindgen {
    ...
    fn create_builder(contents: &str) -> Builder {
        ...
        let lib = pkgconf.probe("gbm").unwrap();
    ...
    pub fn generate_bindings() {
        let bindings = create_builder(&create_header())
            ...
            .whitelist_type("GBM_.*|gbm_.*")
            .whitelist_var("GBM_.*|gbm_.*")
            .whitelist_function("gbm_.*")
            .constified_enum_module("gbm_bo_format")
            .constified_enum_module("gbm_bo_flags")
